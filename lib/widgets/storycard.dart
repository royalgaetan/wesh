...
class StoryCard extends StatelessWidget {
  ...
  const StoryCard({super.key, required this.storiesHandler, required this.storiesHandlerList});
              ...
              child: Column(
                ...
                children: [
                  Wrap(
                    children: [
                      Text(
                        storiesHandler.posterId == FirebaseAuth.instance.currentUser!.uid ? 'Me' : storiesHandler.title,
