...
class _SuggestionsState extends State<Suggestions> {
  ...
  Future sendAnswer(bool answer) async {
    ...
    bool result = await FirestoreMethods.sendFeedback(context, feedbackToSend);
          ...
          firstChild:
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  TextButton(
                    style: ButtonStyle(backgroundColor: MaterialStateProperty.resolveWith((states) => kSecondColor)),
                    onPressed: () {
                      sendAnswer(true);
                    },
                    child: const Text(
