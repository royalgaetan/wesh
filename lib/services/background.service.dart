            ...
            if (result[0] == true) {
              ...
              NotificationApi.showSimpleNotification(
                ...
                body: userNotSeenStories.length == 1
                    ? '❤ ${user.name} a posté une story'
                    : '❤ ${user.name} a posté ${userNotSeenStories.length} ${userNotSeenStories.length > 1 ? 'stories' : 'story'} que vous n\'avez pas encore vue${userNotSeenStories.length > 1 ? 's' : ''}',
                payload: payload,
