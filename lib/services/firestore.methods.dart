...
class FirestoreMethods {
  ...
  //
  {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la création de l\'évènement', null);
      return false;
    }
  }
  ...
  //
  {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la modification de l\'évènement', null);
      return false;
    }
  }
  ...
  //
  {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la création du rappel', null);
      return false;
    }
  }
  ...
  //
  {
    ...
    try {
      ...
      if (context != null) {
        showSnackbar(context, 'An error occured! lors de la modification du rappel', null);
      }
      return false;
    }
  }
  ...
  static Future<bool> createStory(context, uid, Map<String, dynamic> story) async {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la création de la story', null);
      return false;
    }
  }
  ...
  static Future<Widget?> getForeverCoverByFirstStoryId({
    ...
    if (snapshot.docs.isNotEmpty) {
      return snapshot.docs.map((doc) {
        ...
        return getStoryGridPreviewThumbnail(
          isForever: true,
          storySelected: story,
          height: height,
          width: width,
          contentPadding: contentPadding,
          contentMinFontSize: contentMinFontSize,
        );
      }).first;
    }
    return null;
  ...
  static Future createForever(context, uid, Map<String, dynamic> forever) async {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la création du forever', null);
      return false;
    }
  }
  ...
  //
  {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la modification du forever', null);
      return false;
    }
  }
      ...
      FirebaseFirestore.instance.collection('forevers').doc(foreverId).get().then((value) async {
        ...
        if (value.data()!.containsKey('stories')) {
          ...
          if (foreverStories.contains(storyId)) {
            ...
            log('Story removed to the Forever !');
            // showSnackbar(context, 'Story removed from Forever!', kSecondColor);
          } else {
            await refForever.update({
              'stories': FieldValue.arrayUnion([storyId])
            });
            ...
            // showSnackbar(context, 'Story added to Forever!', kSuccessColor);
          }
  ...
  static Future<bool> deleteForever(context, foreverId, userPosterId) async {
    ...
    try {
      ...
      // Remove Fullpage loader
      Navigator.pop(context);
      return true;
    } catch (e) {
      // Remove Fullpage loader
      Navigator.pop(context);
      showSnackbar(context, 'An error occured while deleting the forever', null);
  ...
  static Future<List> createMessage({
    ...
    try {
      ...
      if (result == false) {
        showSnackbar(context, 'An error occured! lors de l\'envoi de votre message', null);
  ...
  //
  {
    try {
      ...
      log('Error : $e');
      showSnackbar(context, 'An error occured while sending the message!', null);
      return false;
    }
  }

  static Future deleteMessages(
      context, Map<String, Message> messagesSelectedList, bool shouldAlsoDeleteAssociatedMessageFiles) async
  //
  {
    ...
    try {
      messagesSelectedList.forEach((key, currentMessage) async {
        ...
        if (shouldAlsoDeleteAssociatedMessageFiles) {
  ...
  static Future createNotification(context, uid, contentId, type) async {
    ...
    //   return refNotif.id;
    // } catch (e) {
    //   showSnackbar(context, 'An error occured! lors de la création de la notification', null);
    //   return '';
    // }
  }
  ...
  static Future sendBugReport(context, Map<String, dynamic> reportToSend) async {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! lors de la création du rapport', null);
      return false;
    }
  }
  ...
  static Future sendQuestion(context, Map<String, dynamic> questionToSend) async {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! avec votre question', null);
      return false;
    }
  }
  ...
  static Future sendFeedback(context, Map<String, dynamic> feedbackToSend) async {
    ...
    try {
      ...
      showSnackbar(context, 'An error occured! avec votre feedback', null);
      return false;
    }
  }
